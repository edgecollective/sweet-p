...
my_text="Distance (inches): "+str(int(my_depth/25.4))+""
if(my_depth==300 or my_depth==9999):
    my_text+=" ???"
my_text+="\nBattery (Volts): {:.2f}".format(my_batt)
my_text+="\nCounter: "+str(index)
text_area.color=color_white
